...
export interface ImageDownloadEmit {
  on(
    event: "start",
    arg: (attributes: MangaAttributes, link: string) => void
  ): this;
  on(
    event: "noimage",
    arg: (attributes: MangaAttributes, link: string) => void
...
export interface ChapterDownloadEmit {
  on(
    event: "start",
    arg: (attributes: MangaAttributes, link: string, pages: number) => void
  ): this;
  on(
    event: "page",
    arg: (
  ...
  on(
    event: "compressing",
    arg: (attributes: MangaAttributes, path: string) => void
  ): this;
  on(
    event: "compressed",
    arg: (
  ...
  on(
    event: "done",
    arg: (attributes: MangaAttributes, downloadPath: string) => void
  ): this;
}
...
export interface ChaptersDownloadEmit {
  ...
  on(
    event: "page",
    arg: (attributes: MangaAttributes, totalPages: number) => void
  ): this;
  on(
    event: "noimage",
    arg: (attributes: MangaAttributes, links: string[]) => void
  ): this;
  on(
    event: "endchapter",
    arg: (attributes: MangaAttributes, current: number, total: number) => void
  ): this;
  on(
    event: "done",
    arg: (manga: string, downloadLocations: string[]) => void
  ): this;
}
...
export interface VolumeDownloadEmit {
  ...
  on(
    event: "compressing",
    arg: (manga: string, locations: string[]) => void
  ): this;
  on(
    event: "compressed",
    arg: (manga: string, stats: CompressStats) => void
  ): this;
  on(
    event: "done",
    arg: (manga: string, volume: number, downloadLocations: string[]) => void
  ): this;
}
...
export interface VolumesDownloadEmit {
  ...
  on(
    event: "chapters",
    arg: (volume: number, volumeIndex: number, chapters: string[]) => void
  ): this;
  on(
    event: "startvolume",
    arg: (
